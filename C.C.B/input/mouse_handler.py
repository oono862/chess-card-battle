...
def handle_mouse_click(pos, mouse_state_globals):
    ...
    # ========================================================================
    # TODO: 以下の処理を将来的に実装する必要があります
    # ========================================================================
    # 1. 保留中の確認ダイアログ処理（約200行）
    #    - 墓地ルーレット確認
    #    - 迅雷2回目使用確認
    #    - 暴風2回目使用確認  
    #    - 灼熱で凍結駒がない場合の確認
    ...
    #
    # 4. プロモーション選択処理（完了）
    #    - ui/overlay.pyのhandle_promotion_click()に移行済み
    #
    # 5. 盤面クリック処理（約400行）
    #    - pending処理（target_tile, target_tiles_multi, target_piece, etc.）
    #    - 駒の選択と移動
    #    - 封鎖タイルの判定
    #    - 凍結駒の判定
    #    - キング存在チェック
    ...
    #    - AI思考開始
    #
    # 現在の実装（Card Game.py内）を参照して実装してください。
    # ========================================================================
    
    # NOTE: 上記の未実装処理については、現在Card Game.py内のhandle_mouse_click関数で
    # 処理されています。完全移行は複雑度が高いため、段階的に行う必要があります。
