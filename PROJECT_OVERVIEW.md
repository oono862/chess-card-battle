...
| カード名 | コスト | 効果 |
|---------|-------|------|
| **迅雷** | 3 | このターンに追加で1ターン分行動可能（合計2ターン） |
| **鉄壁** | 2 | ①発動した暴風・迅雷・ハンです☆・命がけギャンブルを1回無効化、②または次に受ける相手の効果を1回防御（どちらか一方が発動すると消滅） |
| **氷結** | 2 | 相手の駒1つを選択→2ターン凍結（移動不可）※鉄壁の防御対象 |
| **灼熱** | 2 | 凍結解除 or タイル3つを2ターン封鎖※鉄壁の防御対象 |
| **2ドロー** | 1 | カードを2枚引く |
| **暴風** | 3 | 次の移動で駒を1つ飛び越え可能※鉄壁で無効化可能 |
| **錬成** | 0 | PP+1（最大3） |
...
| **摂取** | 1 | PP2回復 |
| **ハンです☆** | 2 | 相手の手札からランダムで1枚墓地に送る※鉄壁で無効化可能 |
| **命がけのギャンブル** | 3 | 25%で自駒以外をクイーン昇格、失敗で相手駒昇格・自ターンスキップ※鉄壁で無効化可能 |
