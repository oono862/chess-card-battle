...
def process_pending_actions(game, ai_player, chess_current_turn, chess):
    """保留中の処理を実行する
    ...
    # 命がけのギャンブル: ルーク・キング以外の駒をクイーンに変える
        ...
        chess_current_turn = process_gamble_promote(game, ai_player, chess_current_turn, chess)
    
    return chess_current_turn


def process_gamble_promote(game, ai_player, chess_current_turn, chess):
    """命がけのギャンブルの処理を実行する
